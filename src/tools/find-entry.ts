import type { PredicateCallbackFromEntry } from '../types/callback-types';
...
export function findEntryKeyByPredicate<E extends UnknownEntry, X extends UnknownArray, T>(thisArg: T, entries: E[], predicate: PredicateCallbackFromEntry<E, X, T>, extra: X): EntryKeyType<E> | null {
  return findEntryKey(
    entries,
